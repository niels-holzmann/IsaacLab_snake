...
parser = argparse.ArgumentParser(description="Tutorial on running the snake RL environment.")
...
from omni.isaac.lab_tasks.manager_based.classic.snake.snake_env_cfg import SnakeEnvCfg
